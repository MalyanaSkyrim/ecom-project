...
>(({ className, ...props }, ref) => {
  ...
  return (
    <FormItemContext.Provider value={{ id }}>
      <div
        ref={ref}
        className={classMerge('space-y-2', className)}
        {...props}
      />
...
>(({ className, ...props }, ref) => {
  ...
  return (
    <Label
      ref={ref}
      className={classMerge(error && 'text-destructive', className)}
      htmlFor={formItemId}
      {...props}
    />
  )
...
>(({ className, ...props }, ref) => {
  ...
  return (
    <p
      ...
      className={classMerge('text-muted-foreground text-[0.8rem]', className)}
      {...props}
    />
  )
})
